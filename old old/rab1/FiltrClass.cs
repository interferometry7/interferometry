...
namespace rab1
{
 ...
 // -------------------------------------------------------------------------------------------------- Медианная фильтрация
       ...
       public static void Filt_Sobel(PictureBox pictureBox01, ProgressBar progressBar1, int k_filt)
       {
       ...
       public static void Filt_BW(PictureBox pictureBox01, ProgressBar progressBar1, int k_filt)
       {
           int k = k_filt;
